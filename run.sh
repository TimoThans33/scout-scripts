...
# run project
gnome-terminal --command "docker run -it --net=host --mount type=bind,source=$1, target=/home  $DOCKER_IMAGE_NAME /usr/local/bin/primevision/arq-mapp -P 4220 -n "scout_api" -p "pv" -c "/home/$1""
